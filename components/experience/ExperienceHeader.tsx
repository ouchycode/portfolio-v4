...
export function ExperienceHeader({
  ...
  return (
    <div className="flex flex-col gap-3 md:gap-4">
      <div className="exp-row inline-flex items-center gap-2 px-4 py-2 mb-2 rounded-full border border-[#DADCE0] dark:border-[#5F6368]/60 bg-white dark:bg-[#303134] shadow-sm w-fit">
        <Briefcase size={14} className="text-[#1A73E8] dark:text-[#8AB4F8]" />
      ...
      <p className="exp-row text-sm md:text-base lg:text-lg text-[#5F6368] dark:text-[#9AA0A6] max-w-2xl mt-1 leading-relaxed">
        {subtitle}
      </p>
    </div>
  );
