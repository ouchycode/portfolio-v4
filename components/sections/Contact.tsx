      ...
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col gap-8 md:gap-12">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            {/* Wrapper Badge Fast Response */}
            <div className="contact-input hidden md:flex shrink-0">
              <div className="flex items-center gap-3 px-4 py-2.5 rounded-full border border-[#DADCE0] dark:border-[#3C4043] bg-white dark:bg-[#303134] shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 relative">
          {/* WRAPPER ICON PAPERCLIP */}
          <div className="contact-input absolute top-2 -left-2 md:-top-4 md:left-auto md:right-[55%] z-20 hidden md:block">
            <div className="p-2 md:p-3 bg-white dark:bg-[#303134] rounded-lg md:rounded-xl shadow-[0_15px_30px_rgba(26,115,232,0.15)] dark:shadow-[0_15px_30px_rgba(0,0,0,0.5)] border border-[#DADCE0] dark:border-[#3C4043] backdrop-blur-sm -rotate-12">
              <Paperclip className="w-5 h-5 md:w-6 md:h-6 text-[#1A73E8] dark:text-[#8AB4F8]" />
            </div>
          </div>

          {/* WRAPPER ICON BINTANG */}
          <div className="contact-input absolute -bottom-4 -right-2 md:-bottom-6 md:-right-6 z-20">
            <div className="p-2.5 md:p-3 bg-white dark:bg-[#303134] rounded-full shadow-[0_15px_30px_rgba(250,187,5,0.15)] dark:shadow-[0_15px_30px_rgba(0,0,0,0.5)] border border-[#DADCE0] dark:border-[#3C4043] backdrop-blur-sm rotate-12">
