...
export default function Hero() {
  ...
  return (
    <section
      ref={container}
      className="relative min-h-screen flex flex-col justify-center px-4 py-20 md:px-10 text-[#202124] dark:text-[#E8EAED] transition-colors duration-500 overflow-hidden"
    >
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-16 mt-10 md:mt-0">
        ...
        <div className="relative w-full md:w-[340px] flex flex-col gap-5 shrink-0 mt-12 md:mt-0 pt-4 md:pt-0">
          <div className="reveal-card absolute -top-6 -left-2 md:-top-8 md:-left-10 z-20">
            <div className="p-2.5 md:p-3.5 bg-white dark:bg-[#303134] rounded-xl md:rounded-2xl shadow-[0_15px_30px_rgba(26,115,232,0.15)] dark:shadow-[0_15px_30px_rgba(0,0,0,0.5)] border border-[#DADCE0] dark:border-[#3C4043] backdrop-blur-sm -rotate-12">
              <Laptop className="w-5 h-5 md:w-7 md:h-7 text-[#1A73E8] dark:text-[#8AB4F8]" />
            </div>
          </div>
          <div className="reveal-card absolute -bottom-4 -right-1 md:-bottom-6 md:-right-8 z-20">
            <div className="p-3 md:p-4 bg-white dark:bg-[#303134] rounded-full shadow-[0_15px_30px_rgba(250,187,5,0.15)] dark:shadow-[0_15px_30px_rgba(0,0,0,0.5)] border border-[#DADCE0] dark:border-[#3C4043] backdrop-blur-sm rotate-12">
              <Zap className="w-5 h-5 md:w-6 md:h-6 text-[#FABB05] fill-[#FABB05]/20" />
            </div>
          </div>
          <div className="reveal-card absolute top-[35%] -right-3 md:-right-12 z-0">
            <div className="p-2 md:p-3 bg-white dark:bg-[#303134] rounded-lg md:rounded-xl shadow-[0_15px_30px_rgba(234,67,53,0.15)] dark:shadow-[0_15px_30px_rgba(0,0,0,0.5)] border border-[#DADCE0] dark:border-[#3C4043] backdrop-blur-sm rotate-12">
              <Palette className="w-5 h-5 md:w-6 md:h-6 text-[#EA4335] dark:text-[#F28B82]" />
            </div>
          </div>

          <div className="reveal-card relative z-10 w-full">
            <div className="flex items-center gap-4 p-5 md:p-6 rounded-[24px] border border-white/60 dark:border-[#3C4043] bg-white/90 dark:bg-[#303134]/90 backdrop-blur-md shadow-[0_20px_50px_-12px_rgba(0,0,0,0.12)] dark:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] hover:-translate-y-1 hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.18)] transition-all duration-300">
