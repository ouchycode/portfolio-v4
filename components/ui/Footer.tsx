  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col gap-10 md:gap-16">
        <div className="w-full rounded-[28px] border border-white/60 dark:border-[#3C4043] bg-white/90 dark:bg-[#303134]/90 backdrop-blur-md shadow-[0_20px_50px_-12px_rgba(0,0,0,0.12)] dark:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] p-8 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 hover:-translate-y-1 hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.18)] transition-all duration-300">
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-4">
            <div className="footer-item inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#E6F4EA] dark:bg-[#81C995]/15 text-[#137333] dark:text-[#81C995] text-xs font-bold uppercase tracking-wider mb-2">
        ...
        <div className="flex flex-col gap-6 md:gap-8 pt-8 border-t border-[#DADCE0] dark:border-[#3C4043]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-2">
            <div className="footer-item flex items-center gap-4 text-xs font-medium text-[#9AA0A6] dark:text-[#5F6368]">
