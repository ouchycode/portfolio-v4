...
export function HeroBadge({ label }: HeroBadgeProps) {
  return (
    <div className="reveal-card inline-flex items-center gap-2 px-4 py-2 mb-8 md:mb-10 rounded-full border border-[#DADCE0] dark:border-[#5F6368]/60 bg-white dark:bg-[#303134] shadow-sm">
      <Sparkles
        size={14}
